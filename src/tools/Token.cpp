...
{
  TokenExtractor *extractor = ft::alloc<TokenExtractor>();

  extractor->next(ft::alloc<TokenSymboleExtractor>())
          ->next(ft::alloc<TokenNumberExtractor>())
          ->next(ft::alloc<TokenBoolExtractor>())
          ->next(ft::alloc<TokenOnOffExtractor>())
          ->next(ft::alloc<TokenSizeExtractor>());
